...
public class CameraMotionControls : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        {           
            xVelocity = Mathf.Clamp(Input.GetTouch(0).deltaPosition.x, -1.0f, 1.0f);
            yVelocity = Mathf.Clamp(Input.GetTouch(0).deltaPosition.y, -1.0f, 1.0f);
        }
#endif
...
#if UNITY_ANDROID || UNITY_IOS || UNITY_WSA || UNITY_WEBGL
